...
<header>Generar un valor aleatorio entre 1 y 100, luego imprimir en la página desde 1 hasta el valor generado (While)</header>
<div class="espacio"></div>
<div class="ejercicio">
<div class="respuesta">
  <p>Nuemero generado de manera aleatoria</p>
<?php
  $numero = rand(1, 100);
  echo "<p>$numero</p>";
?>
